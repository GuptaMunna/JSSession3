...
*/
let profileNameArrays = profiles.map(profile => {
	return profile.name.title + profile.name.first + profile.name.last;
});
...
const profilesData = [
	...
	},
	{
		...
		photo_details: {
			photos: [{ small: 'bar-2', medium: 'baz-2' }, { small: 'fizz-2', medium: 'buzz-2' }],
		},
	},
];
